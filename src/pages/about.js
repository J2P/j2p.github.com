        ...
        <div className="page">
          ...
          <div className="page__body">
            ...
            <ul>
              ...
              <li>
                Blog : <a href="http://blog.j2p.io">http://blog.j2p.io</a>
              </li>
              <li>
                GitHub : <a href="https://github.com/J2P">https://github.com/J2P</a>
              </li>
            </ul>
            <h2>기술스택</h2>
            <ul>
            ...
            <h2>경력</h2>
            <h3>
              (주) 당근마켓 <code className="language-text">2018.12.04 ~ </code>
            </h3>
            <ul>
            ...
            <h3>
              ODK Media <code className="language-text">2018.4.23 ~ 2018.11.30</code>
            </h3>
            <ul>
            ...
            <h3>
              (주) 스마트스터디 <code className="language-text">2012.7 ~ 2017.12.18</code>
            </h3>
            <ul>
              ...
              <li>
                구글, 앱 스토어 순위를 크롤링해서 메일로 받아 볼 수 있도록 구현, 스토어에 들어가서 확인하는 번거로움을
                개선
              </li>
            ...
            <h3>
              (주) 그린비 출판사 <code className="language-text">2011.01 ~ 2012.04</code>
            </h3>
            <ul>
            ...
            <h3>
              (주) ANIJ <code className="language-text">2008.10 ~ 2011.02</code>
            </h3>
            <ul>
            ...
            <h3>
              (주) 아이커머 <code className="language-text">2007.08 ~ 2008.09</code>
            </h3>
            <ul>
            ...
            <ul>
              <li>
                정보기기 운영 기능사(한국산업인력공단) <code className="language-text">2000.05.24</code>
              </li>
              <li>
                리눅스 마스터 2 급 (한국정보통신 인력개발센터) <code className="language-text">2006.08.04</code>
              </li>
              <li>
                인터넷 정보관리사 2 급 (한국정보통신 인력개발센터) <code className="language-text">2006.12.15</code>
              </li>
              <li>
                정보처리 산업기사 (한국산업인력공단) <code className="language-text">2006.12.18</code>
              </li>
              <li>
                MCP Exam 70-290 (Microsoft certified) <code className="language-text">2008.06.14</code>
              </li>
              <li>
                인명구조요원 (대한적십자사) <code className="language-text">2017.06.03</code>
              </li>
            </ul>
            <h2>기타활동</h2>
            ...
            <ul>
              ...
              <li>
                <a href="https://github.com/denoland/deno/commits?author=J2P">https://github.com/denoland/deno</a>
              </li>
            </ul>
            <h3>Where is mask</h3>
            <p>개인 프로젝트</p>
            ...
            <ul>
              ...
              <li>React.js</li>
              <li>
                <a href="https://mask.j2p.dev" target="_blank" rel="noopener noreferrer">
                  https://mask.j2p.dev
                </a>
              </li>
              <li>
                <a href="https://github.com/J2P/where-is-mask">https://github.com/J2P/where-is-mask</a>
              </li>
            </ul>
            <h3>Hanzai Game</h3>
            <p>개인 프로젝트</p>
            ...
            <ul>
              <li>React.js</li>
              <li>
                <a href="https://hanja.j2p.dev" target="_blank" rel="noopener noreferrer">
                  https://hanja.j2p.dev
                </a>
              </li>
              <li>
                <a href="https://github.com/J2P/play-hanzai">https://github.com/J2P/play-hanzai</a>
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <a href="https://github.com/J2P/react-bingo">https://github.com/J2P/react-bingo</a>
              </li>
              <li>
                <a href="https://github.com/J2P/react-bingo-server">https://github.com/J2P/react-bingo-server</a>
              </li>
            </ul>
            <h3>Number Game</h3>
            ...
            <ul>
              ...
              <li>
                <a href="https://github.com/J2P/number">https://github.com/J2P/number</a>
              </li>
            </ul>
            <h3>Typing Game</h3>
            ...
            <ul>
              ...
              <li>
                <a href="https://github.com/J2P/typing">https://github.com/J2P/typing</a>
              </li>
            </ul>
          </div>
        </div>
